<template>
    <!-- 显示设备录制流 -->
    <WebRTC ref="webrtc" title="显示设备录制流">
        <template #video="{ stream }">
            <el-row :gutter="50">
                <el-col class="center" :xs="24" :sm="24" :md="12">
                    <el-divider content-position="left">Display media recorder</el-divider>
        ...
        <template #list="{ support }">
            <div class="mb-20">
                ...
                <el-button type="primary" class="ml-20" :disabled="!support.supDisplayMedia"
                           @click="startHandler">开始</el-button>

                <el-button type="danger" class="ml-20" :disabled="!support.supDisplayMedia"
