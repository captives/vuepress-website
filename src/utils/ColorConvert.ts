 ...
 */
export const rgb2hex = function rgb2hex(rgb: string) {
    // var  rgb = this;
    //十六进制颜色值的正则表达式
 ...
 */
export const hex2rgb = function hex2rgb (hex: string): Array<number> | string {
    // var hex = this;
 ...
 * @returns 
 */
function showRGB(rgb: [number, number, number]) {
    var hexcode = "#";
    //获取RGB值
    for (var x = 0; x < 3; x++) {
        var n: number = rgb[x];
